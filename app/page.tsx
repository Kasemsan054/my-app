    ...
    <div className="space-y-8 max-w-7xl mx-auto pb-12">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 text-slate-900 font-bold text-lg">
          <PlusCircle size={20} className="text-blue-600" /> ออกใบแจ้งเปิดงานซ่อมฉบับใหม่ (Create Repair Ticket)
        </div>
        
        <ReturnForm companies={companies} products={products} currentUser={currentUser} staffs={JSON.parse(JSON.stringify(staffs))} />
      </div>
    </div>
  )
}